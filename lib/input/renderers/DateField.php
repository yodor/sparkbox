...
class DateField extends InputRenderer implements IHeadRenderer
{
  ...
  {
      echo "<script type='text/javascript' src='".SITE_ROOT."lib/js/CalendarPopup.js'></script>";
      echo "\n";
  }
  public function renderStyle()
  {
      echo "<link rel='stylesheet' href='".SITE_ROOT."lib/css/CalendarPopup.css' type='text/css'>";
      echo "\n";
  }
