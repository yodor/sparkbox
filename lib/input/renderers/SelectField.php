...
class SelectField extends DataSourceField
{
  ...
  public function renderField(InputField $field, $render_index=-1)
  {
    ...
    if ($field->getLinkField() instanceof InputField) {
  ...
  public function createFreetextField(InputField $field)
  {
      $field_link = new InputField($field->getName()."_other", "Please Specify",0);
