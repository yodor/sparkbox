...
class SessionFileField extends SessionUploadField 
{
  ...
  public function renderArrayContents()
  {
	...
	$validator = $this->ajax_handler->createValidator(UploadControlAjaxHandler::VALIDATOR_FILE);
...
// 	  if(is_null($storage_object) || $storage_object->isPurged())continue;
  ...
  public function __construct()
  {
      ...
      $this->setClassName("SessionFileField SessionUpload UploadControl");
  }
