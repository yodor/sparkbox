...
class AdminUserInputForm extends InputForm
{
	...
	public function __construct() 
	{
	  ...
	  $field = new InputField("fullname", "Full Name", 0);
	  $field->setRenderer(new TextField());
	  $this->addField($field);
	  ...
	  $field = new InputField("password_hash","Password Hash",1);
	  $field->setRenderer(new HiddenField());
	  
	  //transact this field to dbfield password
	  $field->setValueTransactor(new CustomFieldTransactor("password"));
	  $this->addField($field);


	  
	  $field = new InputField("access_level","Access Level",1);
	  ...
	  $field = new InputField("role","Admin Roles",0);
