	...
	var methods={
		init:function(options){
			var defaults={ 
				...
				scrollInertia:350, /*scrolling inertia: integer (milliseconds)*/
				...
				scrollButtons:{ /*scroll buttons*/
					...
					scrollSpeed:10, /*scroll buttons continuous scrolling speed: integer*/
		...
		update:function(){
			...
			if(mCSB_containerH>mCustomScrollBoxH && !$this.data("horizontalScroll") && !$(document).data("mCS-is-touch-device")){ /*content needs vertical scrolling*/
				...
				var mCSB_draggerContainerH=mCSB_draggerContainer.outerHeight(true);
				...
				var mCSB_draggerH=mCSB_dragger.outerHeight(true),
