...
abstract class PaginatorComponent extends Component implements IHeadRenderer
{
	...
	{
	    echo "<link rel='stylesheet' href='".SITE_ROOT."lib/css/PaginatorComponent.css' type='text/css' >";
	    echo "\n";
	}
