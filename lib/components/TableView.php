...
class TableView extends AbstractResultView implements IHeadRenderer
{
  ...
  {
      echo "<link rel='stylesheet' href='".SITE_ROOT."lib/css/TableView.css' type='text/css' >";
      echo "\n";
  }
  ...
  public function insertColumnAfter(TableColumn $column, $after_column_name)
  {
    ...
    array("$column_name" => $column) +
    array_slice($this->columns, $index+1, count($this->columns) - 1, true) ;
