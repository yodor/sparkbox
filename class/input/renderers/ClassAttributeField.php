...
class ClassAttributeFieldAjaxHandler extends JSONRequestHandler
{
    ...
    {
	$field = new ArrayInputField("value", "Category Attributes", 0);
...
class ClassAttributeField extends DataSourceField implements IArrayFieldRenderer, IHeadRenderer
{
  ...
  {
      echo "<link rel='stylesheet' href='".SITE_ROOT."css/ClassAttributeField.css' type='text/css' >";
      echo "\n";
  }
  public function getHeadClass()
  {
      return "ClassAttributeField";
  }
