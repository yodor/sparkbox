...
$art = new ArrayField(new TextField($textField));
...
$art1 = new ArrayField(new TextArea($textArea));
...
//
//$dateField->getArrayRenderer()->setItemRenderer(new DateField());
...
//
//$checkField->getArrayRenderer()->setItemRenderer($cr);
...
//
//$radioField->getArrayRenderer()->setItemRenderer($rr);
...
//
//$phoneField->getArrayRenderer()->setItemRenderer(new PhoneField());
...
////$f18->append_offset = -1;
//$timeField->getArrayRenderer()->setItemRenderer(new TimeField());
